...
void RunAction::BeginOfRunAction(const G4Run* /*run*/)
{
  ...
  analysisManager->CreateNtupleDColumn("phiIn");

  analysisManager->CreateNtupleDColumn("pOut");
  analysisManager->CreateNtupleDColumn("thetaOut");
  analysisManager->CreateNtupleDColumn("phiOut");
